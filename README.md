...
2. **智能双轨路由**：
   - 识别到 `情色` / `香艳` 关键词 → 跨 Skill 调用 `erotic-prompt-generator` 执行安全隐喻转译（湿纱贴体、肢体张力特写、影子折射、器物双关）。
   - 通用风雅 / 写实场景 → 跨 Skill 调用 `aesthetic-prompt-generator` 注入相机参数、高级光影与渲染器。
...
### Q3: 修改或自定义技能规则该去哪里？
- 若需要修改生图核心脚本与节奏 → 编辑 `D:\AI\image\.agents\skills\gemini-browser-auto-illustrator\scripts\run_gemini.py`
- 若需要调整触发生图的规则逻辑 → 编辑 `D:\AI\image\AGENTS.md` 与 `SKILL.md`

---

## 🖼️ 图片说明

仓库中的图片已经整理到 `images/` 目录，可直接在 GitHub 上查看。下面给出一些代表性作品：

- Gemini AI 创作
  - ![Gemini 示例](images/Gemini_Generated_Image_1esa5k1esa5k1esa.png)
- 邯郸梦境
  - ![邯郸梦境](images/handan_p1_qiao_tou_kui_1785299912478.png)
- 露滴牡丹
  - ![露滴牡丹](images/ludi_mudan_p1_ban_tui_ban_jiu_1785299513750.png)
- 桃红柳绿
  - ![桃红柳绿](images/peach_willow_p1_1785199464543.png)
- 书房月影
  - ![书房月影](images/study_moonlight_p1_1785199454288.png)
- 古典工笔
  - ![古典工笔](images/tang_lady_gongbi.jpg)
